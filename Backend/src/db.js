...
const db = {
    ...
    async initDb() {
        ...
        const uri = "mongodb://naitikpawar98_db_user:Naitik123@ac-0fofvln-shard-00-00.xe4tvjl.mongodb.net:27017,ac-0fofvln-shard-00-01.xe4tvjl.mongodb.net:27017,ac-0fofvln-shard-00-02.xe4tvjl.mongodb.net:27017/?ssl=true&replicaSet=atlas-md76qe-shard-0&authSource=admin&retryWrites=true&w=majority";
        const dbName = "o2c_database";
